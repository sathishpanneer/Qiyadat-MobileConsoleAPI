...
namespace Uaeglp.Web.Controllers
{
    ...
    public class AppSettingController : ControllerBase
    {
        ...
        [HttpDelete("delete-appSetting/{key}", Name = "DeleteAppSetting")]
        public async Task<IActionResult> DeleteAppSetting(string key)
        {
            var result = await _service.DeleteAppSettingAsync(key);
            return Ok(result);
        }
    }
}
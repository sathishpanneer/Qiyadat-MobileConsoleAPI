    ...
    public class EmailService : IEmailService
    {
            ...
            LanguageType languageType = LanguageType.EN)
        {
            ...
            try
            {
                ...
                var templateInfo = await _appDbContext.TemplateInfos.Include(k => k.EmailHeaderAndFooterTemplate).FirstOrDefaultAsync(k => k.Id == 13003);
        ...
        public async Task<EmailView> SendRequestCallbackEmailAsync(string name, string mailAddress, string contact, string fromEmail, string userName)
        {
            ...
            try
            {
                ...
                var templateInfo = await _appDbContext.TemplateInfos.Include(k => k.EmailHeaderAndFooterTemplate).FirstOrDefaultAsync(k => k.Id == 13004);
        ...
        public async Task<EmailView> SendReportProblemEmailAsync(string reportText, string fromEmail, string userName)
        {
            ...
            try
            {
                ...
                var templateInfo = await _appDbContext.TemplateInfos.Include(k => k.EmailHeaderAndFooterTemplate).FirstOrDefaultAsync(k => k.Id == 7);
        ...
        public async Task<EmailView> SendAssessmentReminderAsync(string toEmail, string content, string userName)
        {
            ...
            try
            {
                ...
                var templateInfo = await _appDbContext.TemplateInfos.Include(k => k.EmailHeaderAndFooterTemplate).FirstOrDefaultAsync(k => k.Id == 13005);
        ...
        public async Task<EmailView> SendAssessmentCoordinatorReminderAsync(string toEmail, string content, string userName)
        {
            ...
            try
            {
                ...
                var templateInfo = await _appDbContext.TemplateInfos.Include(k => k.EmailHeaderAndFooterTemplate).FirstOrDefaultAsync(k => k.Id == 411);

            ...
            try
            {
               ...
               // message.SeenByIDs.Add(userId);
                ...
                foreach (var recipientUserID in userIds)
                {
                    ...
                    {
                        await AddNotificationAsync(recipientUserID, ActionType.Messaging, messages.ID.ToString(), ParentType.Messaging, messages.OwnerID, notifyText, room.ID.ToString());
                    }
                }

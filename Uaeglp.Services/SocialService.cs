    ...
    public class SocialService : ISocialService
    {
        ...
        private async Task FillNotificationUserDetailsAsync(int userId, List<NotificationView> notificationsList)
        {
            foreach (var notification in notificationsList)
            {
                ...
                if(notification.ActionID == ActionType.Meetup)
                {
                ...
                if (notification.ActionID == ActionType.Programme)
                {
                ...
                if (notification.ActionID == ActionType.Batch)
                {
                ...
                if (notification.ActionID == ActionType.Group)
                {
                ...
                if (notification.ActionID == ActionType.Assessment)
                {
                ...
                if (notification.ActionID == ActionType.AssignedAssessment)
                {
                ...
                if (notification.ActionID == ActionType.AssessmentCoordinator)
                {
                    var assesmentGroupMember = await _appDbContext.AssessmentGroupMembers.Where(x => x.Id == Convert.ToInt32(notification.ParentID)).FirstOrDefaultAsync();
                    if(assesmentGroupMember != null)
                    {
        ...
        public async Task<ISocialResponse> GetAnnouncementsAsync()
        {
            try
            {
                ...
                foreach (var item in announcements)
                {
                    ...
                    view.IsAnnouncement = item.Highlights;
